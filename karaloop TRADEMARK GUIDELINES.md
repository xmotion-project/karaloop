...
your unrestricted modification of the copyrighted material (the "Material", e.g. source files, code, documentation), we cannot be sure that your modifications to the Project's Materials are ones that will not be misleading if distributed under the same name. Instead, this Policy describes the circumstances under which you may use the Project's trademarks.
...
## Use for non-software and non-hardware goods and services
...
#### Events
You can use the signage in the <<Brand Standards>> to promote the Project at events.

### Uses for which we are granting a license
#### User groups
You can use the Word Marks as part of your user group name provided that:

The main focus of the group is the Material;
...
#### Promotional goods
"Promotional goods" are non-software and non-harware goods that use the Marks and that are intended to advertise the Project, promote the Project, or show membership in the Project community.
