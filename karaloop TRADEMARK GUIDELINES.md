...
your unrestricted modification of the copyrighted material (the "Material", e.g. source files, executable code we have compiled, documentation), we cannot be sure that your modifications to the Project's Materials are ones that will not be misleading if distributed under the same name. Instead, this Policy describes the circumstances under which you may use the Project's trademarks.
...
<<Example for **karaloop**: "Any mark ending with the letters KARALOOP or ARALOOP" and "Any mark beginning with the letters KARALOOP">>
